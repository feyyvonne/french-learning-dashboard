...
Open `index.html` in a browser. The app uses CDN-hosted React and Tailwind, so an internet connection is needed the first time it loads those libraries.
